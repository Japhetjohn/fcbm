      ...
      <div className="container-custom relative">
        ...
        <div className="grid lg:grid-cols-5 gap-8 lg:gap-12 items-center">
          ...
          <div className="slide-in-left lg:col-span-2 order-2 lg:order-1">
            ...
            <div className="mb-6 sm:mb-8">
              <div className="flex flex-col sm:flex-row sm:items-baseline gap-2 sm:gap-4 mb-3">
                ...
                <div>
                  <h2 className="font-serif text-xl sm:text-h3 text-white leading-tight">{wine.name}</h2>
            ...
            <div className="flex flex-wrap gap-4 sm:gap-6 mb-6 sm:mb-8">
              ...
              <div className="flex sm:block items-center gap-2">
                ...
                <div className="text-[11px] text-white/50 uppercase tracking-wider mt-0 sm:mt-1">Temp</div>
              </div>
              <div className="w-px bg-white/10 hidden sm:block" />
              <div className="flex sm:block items-center gap-2">
                <div className="font-serif text-xl sm:text-2xl text-gold-500">{wine.aging}</div>
                <div className="text-[11px] text-white/50 uppercase tracking-wider mt-0 sm:mt-1">Aging</div>
              </div>
            </div>
          ...
          <div className="lg:col-span-1 order-1 lg:order-2 flex justify-center">
            <div className="relative w-[160px] h-[360px] sm:w-[200px] sm:h-[460px] lg:w-[220px] lg:h-[520px]">
              {/* Glow */}
              ...
              {/* Switcher Arrows */}
              <div className="absolute -bottom-8 sm:-bottom-12 left-1/2 -translate-x-1/2 flex items-center gap-4 z-20">
                <button
                  onClick={prevWine}
          ...
          <div className="slide-in-right lg:col-span-2 order-3">
            <div className="space-y-4 sm:space-y-6">
              {features.map((feature) => {
                ...
                return (
                  ...
                  >
                    <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center flex-shrink-0 group-hover:border-gold-500/30 transition-colors">
                      <IconComponent className="w-4 h-4 sm:w-5 sm:h-5 text-gold-500" />
                    </div>
                    <div>
                      <h3 className="font-serif text-base sm:text-lg text-white mb-1">{feature.title}</h3>
                      <p className="text-xs sm:text-sm text-white/65 leading-relaxed">{feature.description}</p>
                    </div>
                  </div>
                );
              })}
            ...
            {/* Quote */}
            {quote.text && (
              <div className="mt-6 sm:mt-10 p-4 sm:p-6 bg-white/[0.03] rounded-lg border-l-2 border-gold-500/50">
                {quote.prefix && <p className="font-script text-xl sm:text-2xl text-gold-400 mb-2">{quote.prefix}</p>}
