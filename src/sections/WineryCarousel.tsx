    ...
    >
      ...
      <div className="container-custom relative">
        ...
        <div className="fade-up text-center mb-8 sm:mb-12">
          <span className="font-script text-2xl sm:text-3xl text-gold-400 block mb-2">{wineryCarouselConfig.scriptText}</span>
        ...
        <div className="slide-in-left" style={{ transitionDelay: '0.1s' }}>
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-0 items-stretch">
            ...
            <div className="relative aspect-[16/10] sm:aspect-[4/3] lg:aspect-auto lg:min-h-[500px] rounded-lg lg:rounded-r-none overflow-hidden">
              ...
              {/* Navigation Arrows */}
              <div className="absolute bottom-4 sm:bottom-6 left-4 sm:left-6 flex gap-2 sm:gap-3 z-20">
                <button
                  onClick={prevSlide}
            ...
            {/* Content Side */}
            <div className="bg-white/5 lg:bg-white/5 border border-white/10 lg:border-y lg:border-r lg:border-white/10 rounded-lg lg:rounded-r-lg p-6 sm:p-8 lg:p-12 flex flex-col justify-center relative overflow-hidden mt-4 lg:mt-0">
              {slides.map((slide, index) => (
                <div
                  key={index}
